...
export default function OrderProgress({ orders: initialOrders, clientConfig, onNewOrder, onReset }) {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-navy-800 mb-2">Order Progress</h2>
      <p className="text-gray-500 mb-8">
        {allDone ? 'All orders submitted successfully. Returning shortly...' : 'Submitting your orders...'}
      </p>
