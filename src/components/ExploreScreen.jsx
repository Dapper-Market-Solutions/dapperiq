    ...
    <div className="py-10">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-500 max-w-lg mx-auto">
          We have high-intent consumer data across <span className="font-bold underline text-navy-700">virtually every industry and niche in the United States</span>.
